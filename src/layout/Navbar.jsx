function Navbar({ exportJson, autoLayout }) {
  return (
    <nav className="bg-white border-gray-200 shadow-lg fixed w-full left-0 top-0 z-10">
      <div className="flex flex-wrap items-center justify-between p-2 w-full">
        ...
        <a href="#" className="flex items-center">
          ...
          <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">New Flow</span>
        </a>
        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-multi-level">
          <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <button className="border w-24 py-2 border-gray-300 px-4 py-2 rounded" onClick={exportJson}>Export</button>
            </li>
            <li>
            <button onClick={autoLayout} className="top-4 right-4 z-10 bg-blue-500 text-white px-4 py-2 rounded">
        Auto Layout
      </button>
            </li>
          </ul>
